...
public class ChatFirebaseAdapter_Group extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChatFirebaseAdapter_Group(List<Group_Chat> chats) {
        mChats = chats;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_ME:
                ...
                viewHolder = new ChatFirebaseAdapter_Group.MyChatViewHolder(viewChatMine);
                break;
            case VIEW_TYPE_OTHER:
                View viewChatOther = layoutInflater.inflate(R.layout.chat_item_left, parent, false);
                viewHolder = new ChatFirebaseAdapter_Group.OtherChatViewHolder(viewChatOther);
                break;
        }
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (TextUtils.equals(mChats.get(position).getSenderUid(),
            ...
            configureMyChatViewHolder((ChatFirebaseAdapter_Group.MyChatViewHolder) holder, position);
        } else {
            configureOtherChatViewHolder((ChatFirebaseAdapter_Group.OtherChatViewHolder) holder, position);
        }
    }
    private void configureMyChatViewHolder(ChatFirebaseAdapter_Group.MyChatViewHolder myChatViewHolder, int position) {
    ...
    private void configureOtherChatViewHolder(ChatFirebaseAdapter_Group.OtherChatViewHolder otherChatViewHolder, int position) {
        Chat chat = mChats.get(position);
